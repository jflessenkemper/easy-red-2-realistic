...
| 9 | MG-centric squads | No concept of a squad weapon | 🔧 In armies built round the LMG, riflemen form the **Schützenkette on the gunner** — front half of the riflemen to his right, rear half to his left, 4 m interval, frontage capped at 36 m. Sourced from 1939-40 German doctrine (see `.llm/squad-formations.md`); the cap is the **voice-control** limit the manuals give, not a ballistic one — no beaten-zone derivation exists in any manual searched. **The cohering itself is verified live (RALLY-on-MG has fired in every battle); the KETTE GEOMETRY is NOT yet verified in-game** — it is implemented, passes the offline cascade, and is cascade-free by construction, but the battle that would measure it could not be launched. |
